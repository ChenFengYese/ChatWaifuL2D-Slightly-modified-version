...
japanese_model_path = ".\model\G_5000.pth"
japanese_config_path = ".\model\Gconfig.json"
        ...
        try:
            ...
            while True:
                try:
                    ...
                    print(answer)
                    if len(answer.split("接下来是中文回复：")) != 1:
                        answerG = answer.split("接下来是中文回复：")[0]
                        answer = answer.split("接下来是中文回复：")[1]
                    elif outputMethod == 0:
